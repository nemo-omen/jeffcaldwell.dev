...
<section id="work" class="width__body">
  <header class="section-header">
    ...
    <p class="landing-description">
      My goal is to make fast, accessible, great-looking websites and web applications.<br>
      The projects below showcase my commitment to that goal. <br>
    </p>
  </header>
  <FlexSwitcher>
    <Feature
      image={{url: '/images/FeedMe_Feature.png', description: 'FeedMe front page interface.'}}
      status="July 2021 - Ongoing"
      title="FeedMe"
      subtitle="The easy RSS reader"
      link="/work/feedme"
    >
